...
import { RomoBadge, RomoCard } from "@/components/ui";
        ...
        <div className="relative z-10 flex w-full flex-col items-center">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-2">
            {proofPoints.map((point) => {
              ...
              return (
                <span
                  key={point.text}
                  className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.025] px-4 py-2 text-[12px] font-medium text-white/56"
                >
          ...
          <div className="mt-12 grid w-full max-w-5xl gap-4 md:grid-cols-3">
            {steps.map((step) => {
              ...
              return (
                <RomoCard key={step.title} className="text-left">
